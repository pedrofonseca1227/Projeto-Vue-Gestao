<template>
  <div class="container mt-5">
    <h2 class="text-center fw-bold mb-2">🐄 Bovinos – St. André</h2>
    <p class="text-center text-muted mb-4">
      Controle detalhado e visual do rebanho da fazenda St. André
    </p>
    ...
    <div class="row justify-content-between mb-3">
      ...
      <div class="col-md-6 text-end">
        ...
        <router-link to="/adicionarPastoStAndre" class="btn btn-success">
          ➕ Adicionar Animal
        </router-link>
      </div>
    </div>
    ...
    <div class="row g-3 text-center mb-4">
      <div
        ...
        v-for="(valor, chave) in resumoContagem"
        :key="chave"
      >
        <div class="card shadow-sm rounded">
          <div class="card-body p-2">
            <h6 class="mb-1 text-muted text-uppercase" style="font-size: 0.75rem">
              {{ chave }}
            </h6>
